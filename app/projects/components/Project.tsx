 ...
 * TODO: Add repo icon for projects that have public repos
 *
  ...
  return (
    <ProjectCard>
      <div className="flex flex-col items-center space-y-2">
        ...
        <div className="flex w-full flex-col justify-between p-4 text-center xl:text-left">
          {titleDisplay}
